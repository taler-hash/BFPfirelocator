<template>
    <Select v-model="model" :options="stations?.data" optionLabel="name" optionValue="id" class="w-full md:w-56" filter placeholder="Select Station"
        @filter="onFilter" />
</template>
